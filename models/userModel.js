...
const userSchema = new mongoose.Schema({
    ...
    tickets: {type: [mongoose.Schema.Types.ObjectId], ref: 'event'},
...
mongoose.connect('mongodb://127.0.0.1:27017/eventsapplication').then(()=> console.log('Users Database is connected ...')).catch((err)=> console.error('Error connecting to MongoDB: ', err));